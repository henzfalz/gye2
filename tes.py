...
gye = LINE("EuYg3DPlSgju2JBRC6Ic.uWUewBVJBmbLl3/xBz2rFa.sby0KZl5a5eaUAGfwqLA2NJwFsHqIT0YhV2c2rpDi5c=")
gye.log("Auth Token : " + str(gye.authToken))
channelToken = gye.getChannelResult()
gye.log("Channel Token : " + str(channelToken))

ais = LINE("Euq22rZIuzCuNbSmSaFc.ACRdUy4tJ/VlT+R+x5d0ha.KnSjNpIMQiBIvdfAqIb2soYMvEIZGM8ukp7vRuip5j4=")
ais.log("Auth Token : " + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Channel Token : " + str(channelToken))

ki2 = LINE("Euom0Cw4yPAYcuPwo8Ea.pVmKJTunEHB5fGw/GG7xMG.j6dmFzCA4Fq6qxjuOTKaQfkGOxmjkgmOJuXT784zoUk=")
ki2.log("Auth Token : " + str(ki2.authToken))
channelToken = ki2.getChannelResult()
ki2.log("Channel Token : " + str(channelToken))

ki3 = LINE("EuDs0X5q8AIDz9w6x1R1.JBJ59uuOUEEGtNI4kFY4yq.lv/YsjX3+XqtS4azVwjW844nVR+rNkvq3Aj37oHLZ20=")
ki3.log("Auth Token : " + str(ki3.authToken))
channelToken = ki3.getChannelResult()
ki3.log("Channel Token : " + str(channelToken))

KAC = [gye,ais,ki2,ki3]
GUE = [gye,ais,ki2,ki3] # ini jangan luh hapus peak inj fungsi Ciak alias kick
...
Bots = [gyeMID,aisMID,ki2MID,ki3MID]
creator = ["u530b8459bbe36cc0652f7f976d9d917c"]
Owner = ["u530b8459bbe36cc0652f7f976d9d917c"]                
...
#==============================================================================#
                        ...
                        ais.sendMessage(msg.to,responsename1)
                        ki2.sendMessage(msg.to,responsename2)
                        ki3.sendMessage(msg.to,responsename3)
                        ...
                        for mention in mentionees:
                            if gyeMID in mention["M"]:
                                if settings["detectMention"] == True:
                                    ...
                                    gye.sendMessage(to, "Dont tag me,im bot kick...!")
